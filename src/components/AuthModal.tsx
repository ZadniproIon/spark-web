  ...
  return (
    <div className={`modal-overlay ${isClosing ? 'modal-overlay--closing' : ''}`} onClick={handleClose}>
      ...
      >
        ...
        {error && (
          <div style={{ padding: '10px 14px', background: 'var(--red-subtle)', border: '1px solid var(--red-border)', borderRadius: 'var(--radius-button)', marginBottom: 16, fontSize: 13, color: 'var(--red)' }}>
            {error}
          </div>
        )}
